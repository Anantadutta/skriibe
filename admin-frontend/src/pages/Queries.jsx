...
const Queries = () => {
  ...
  return (
    <div style={{ padding: '32px 40px', maxWidth: '1400px', width: '100%', margin: '0 auto', boxSizing: 'border-box' }}>
      {/* Header */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          ...
          <p style={{ color: '#94a3b8', fontSize: '0.9rem', marginTop: '6px' }}>
            Review, investigate, and resolve user-raised queries and feedback.
          </p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px', marginBottom: '28px' }}>
        <div style={{ background: '#13131A', border: '1px solid #1E1E2D', borderRadius: '14px', padding: '18px 20px' }}>
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Total Queries</div>
          <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#fff', marginTop: '6px' }}>{stats.totalCount}</div>
        </div>

        <div style={{ background: '#13131A', border: '1px solid #1E1E2D', borderRadius: '14px', padding: '18px 20px' }}>
          <div style={{ fontSize: '0.8rem', color: '#eab308', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Pending</div>
          <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#eab308', marginTop: '6px' }}>{stats.pendingCount}</div>
        </div>

        <div style={{ background: '#13131A', border: '1px solid #1E1E2D', borderRadius: '14px', padding: '18px 20px' }}>
          <div style={{ fontSize: '0.8rem', color: '#3b82f6', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>In Review</div>
          <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#3b82f6', marginTop: '6px' }}>{stats.inReviewCount}</div>
        </div>

        <div style={{ background: '#13131A', border: '1px solid #1E1E2D', borderRadius: '14px', padding: '18px 20px' }}>
          <div style={{ fontSize: '0.8rem', color: '#10b981', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Resolved</div>
          <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#10b981', marginTop: '6px' }}>{stats.resolvedCount}</div>
        </div>

        <div style={{ background: '#13131A', border: '1px solid #1E1E2D', borderRadius: '14px', padding: '18px 20px' }}>
          <div style={{ fontSize: '0.8rem', color: '#ef4444', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Unread</div>
            ...
            {loading ? (
              ...
              <tr>
                <td colSpan="8" style={{ padding: '48px', textAlign: 'center', color: '#64748b' }}>
                  No queries found matching this criteria.
                </td>
              </tr>
            ) : (
              queries.map((q) => {
                ...
                return (
                  <tr 
                    ...
                    style={{ 
                      ...
                      background: !q.isRead ? 'rgba(99, 102, 241, 0.05)' : 'transparent',
                  ...
                  >
                    ...
                    <td style={{ padding: '14px 20px', color: '#fff', fontWeight: 500, fontSize: '0.85rem' }}>
                      {q.email}
                    </td>
                    <td style={{ padding: '14px 20px', color: '#94a3b8', fontSize: '0.85rem' }}>
                      {q.creatorName ? `@${q.creatorName.replace('@', '')}` : '—'}
                    </td>
                    <td style={{ padding: '14px 20px', color: '#fff', fontWeight: 600, fontSize: '0.85rem' }}>
                      {q.amountPaid ? `₹${q.amountPaid}` : '—'}
                    </td>
                    <td style={{ padding: '14px 20px' }}>
                      <span style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px', marginBottom: '20px' }}>
              ...
              <div style={{ background: '#1A1A24', padding: '12px 16px', borderRadius: '10px', border: '1px solid #252538' }}>
                ...
                <div style={{ fontWeight: 700, color: '#6366F1', marginTop: '4px' }}>
                  <a href={`mailto:${selectedQuery.email}`} style={{ color: '#6366F1', textDecoration: 'none' }}>
                    {selectedQuery.email}
                  </a>
                </div>
              </div>
              ...
              <div style={{ background: '#1A1A24', padding: '12px 16px', borderRadius: '10px', border: '1px solid #252538' }}>
                ...
                <div style={{ fontWeight: 700, color: '#10b981', marginTop: '4px' }}>
                  {selectedQuery.amountPaid ? `₹${selectedQuery.amountPaid}` : '—'}
                </div>
              </div>
            </div>
            ...
            {selectedQuery.evidenceUrl && (
              <div style={{ marginBottom: '20px', background: '#1A1A24', padding: '16px', borderRadius: '10px', border: '1px solid #252538' }}>
                <span style={{ fontSize: '0.75rem', color: '#64748b', textTransform: 'uppercase', fontWeight: 600 }}>Attached Evidence / Screenshot</span>
                <div style={{ marginTop: '10px' }}>
                  <a href={selectedQuery.evidenceUrl} target="_blank" rel="noopener noreferrer">
                    <img 
                      src={selectedQuery.evidenceUrl} 
                      alt="Query Evidence" 
                      style={{ maxWidth: '100%', maxHeight: '240px', borderRadius: '8px', border: '1px solid #334155', objectFit: 'contain' }}
                    />
                  </a>
                  <div style={{ marginTop: '6px' }}>
                    <a href={selectedQuery.evidenceUrl} target="_blank" rel="noopener noreferrer" style={{ color: '#6366F1', fontSize: '0.8rem', textDecoration: 'none' }}>
                      ↗ Open Full Evidence Image
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div style={{ marginTop: '24px', borderTop: '1px solid #1E1E2D', paddingTop: '20px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px', marginBottom: '16px', flexWrap: 'wrap' }}>
                <button
                  ...
                  style={{
                    background: selectedQuery.status === 'pending' ? '#eab308' : '#1E1E2D',
                    color: selectedQuery.status === 'pending' ? '#000' : '#eab308',
                ...
                <button
                  ...
                  style={{
                    background: selectedQuery.status === 'in-review' ? '#3b82f6' : '#1E1E2D',
                    color: selectedQuery.status === 'in-review' ? '#fff' : '#3b82f6',
                ...
                <button
                  ...
                  style={{
                    background: selectedQuery.status === 'resolved' ? '#10b981' : '#1E1E2D',
                    color: selectedQuery.status === 'resolved' ? '#fff' : '#10b981',
                ...
                <button
                  ...
                  style={{
                    background: selectedQuery.status === 'rejected' ? '#ef4444' : '#1E1E2D',
                    color: selectedQuery.status === 'rejected' ? '#fff' : '#ef4444',
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Record investigation notes, email responses sent, or refund transaction IDs..."
                  style={{
                    width: '100%',
                    background: '#1A1A24',
                    border: '1px solid #2D2D3F',
