    ...
    <div className={`min-h-screen transition-colors duration-300 ${theme === 'light' ? 'bg-[#f8fafc] text-black' : 'bg-[#0a0a0f] text-white'} flex flex-col`}>
      ...
      <main className="flex-grow flex flex-col items-center p-6 sm:p-12 relative overflow-hidden font-syne">
        <div className="z-10 max-w-4xl w-full space-y-6 p-8 md:p-12 rounded-3xl text-left" style={{
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#3BA8D8] to-[#7c3aed] mb-8 text-center">
          ...
          <div className={`text-base md:text-lg leading-relaxed space-y-6 ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'} font-sans`}>
            ...
            <p>Skriibe is a creator monetization platform offering three interaction types: Live Chat (real-time, pay-per-minute conversations), AMA (paid asynchronous questions/messages to offline creators), and Tips (voluntary post-chat gratuities). These guidelines apply to all interaction types and all users of the platform.</p>
            ...
            <h2 className={`text-2xl font-bold mt-8 mb-4 ${theme === 'light' ? 'text-black' : 'text-white'}`}>2. Ask Genuine Questions/messages</h2>
            <p>Questions/messages should be clear, relevant, and submitted in good faith.</p>
            <p>Do not:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Submit spam or repetitive questions/messages.</li>
              <li>Submit meaningless or intentionally confusing questions/messages.</li>
              <li>Use automated tools to generate large volumes of questions/messages.</li>
              <li>Attempt to manipulate creators or platform systems.</li>
            </ul>
            <p>Questions/messages that are vague, misleading, or impossible to answer may be flagged by Skriibe and not processed.</p>
            ...
            <p>Users who submit abusive questions/messages may not be eligible for a refund at Skriibe’s discretion. Users who feel harassed or threatened by a creator’s response must report immediately to <a href="mailto:Support@skriibe.com" className="text-[#3BA8D8] hover:underline font-medium">Support@skriibe.com</a>. Skriibe will respond within <strong>48 hours</strong>.</p>
            ...
            <h2 className={`text-2xl font-bold mt-8 mb-4 ${theme === 'light' ? 'text-black' : 'text-white'}`}>7. Respect Creator Boundaries and Interaction Rules</h2>
            <p>Creators choose which questions/messages they answer.</p>
            <p>Creators are not required to respond to questions/messages that:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>Fans must respect these decisions. During Live Chat, users must not: attempt to extend sessions beyond their payment authorization; record, screenshot, or distribute chat content without creator consent; or use the Live Chat feature to solicit off-platform contact. For Tips: Tips must not be used as a form of coercion, conditional reward, or attempt to gain preferential treatment. Creators must not solicit Tips as a condition of service. Tips are expressions of genuine appreciation only.</p>
            ...
            <p>Questions/messages relating to health, law, finance, investments, taxes, mental health, or other regulated fields should not be considered professional advice unless explicitly stated by the creator.</p>
            ...
            <p>13.3 To report a suspected scam: <a href="mailto:Support@skriibe.com" className="text-[#3BA8D8] hover:underline font-medium">Support@skriibe.com</a></p>
            ...
            <p>14.3 If a creator's response makes you feel unsafe or threatened, do not engage further. Report immediately to <a href="mailto:Support@skriibe.com" className="text-[#3BA8D8] hover:underline font-medium">Support@skriibe.com</a> and, if warranted, to your local police or the National Cybercrime Portal (cybercrime.gov.in).</p>
            ...
            <p>Skriibe may take any of the following actions for Creators:</p>
            <div className="space-y-4 my-4">
              <div>
                <p className="font-bold">Strike 1 – Reminder Warning</p>
                <p>Trigger: First verified conduct violation — including abusive response or Community Guidelines breach. Email and in-app notification sent to creator: “Your account has received its first warning. A second violation within 90 days will result in a 48-hour suspension.” Formal Strike 1 recorded on account. No impact on creator profile visibility or Health Score.</p>
              </div>
              <div>
                <p className="font-bold">Strike 2 – 48-Hour Suspension</p>
                <p>Trigger: Second verified conduct violation within 90 days of Strike 1. Account suspended 48 hours. Creator page paused. Removed from discovery page during suspension.</p>
              </div>
              <div>
                <p className="font-bold">Strike 3 – 7-Day Suspension</p>
                <p>Trigger: Third verified conduct violation within 90 days of Strike 1. Account suspended 7 days. No new Live Chat or AMA interactions accepted. Existing paid AMA questions/messages that were already submitted must still be answered. Payouts frozen for the duration.</p>
              </div>
              <div>
                <p className="font-bold">Strike 4 – Permanent Removal</p>
                <p>Account permanently removed from Skriibe. Pending earnings are held for 30 days pending any Buyer disputes, then released minus any disputed amounts. The creator’s registered phone number and email address are blacklisted from creating new accounts. The creator’s historical responses remain accessible to Buyers who received them, but the creator profile is deactivated.</p>
              </div>
            </div>
            <p className="mt-4 font-semibold">Skriibe reserves the right to bypass the strike system and immediately suspend or terminate accounts involved in:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Fraud</li>
              <li>Payment abuse</li>
              <li>Impersonation</li>
            ...
            <div className="space-y-4 my-4">
              <div>
                <p className="font-bold">Strike 1 – Reminder Warning</p>
                <p>Formal warning issued for violating Community Guidelines.</p>
              </div>
              <div>
                <p className="font-bold">Strike 2 – Temporary Suspension</p>
                <p>Account temporarily suspended for 7 days. The Fan may be restricted from submitting new questions/messages during the suspension period.</p>
              </div>
              <div>
                <p className="font-bold">Strike 3 – Permanent Removal</p>
                <p>Account permanently removed from Skriibe.</p>
              </div>
            </div>
            <p className="mt-4 font-semibold">Skriibe reserves the right to bypass the strike system and immediately suspend or terminate accounts involved in:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>Skriibe may update these Community Guidelines from time to time. Material changes will be communicated with at least 7 days’ advance notice via email or in-app notification.</p>
