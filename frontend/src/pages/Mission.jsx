      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 sm:p-12 relative overflow-hidden">
        ...
        <div className="z-10 max-w-3xl text-center space-y-10 p-8 md:p-14 rounded-3xl" style={{
          ...
          <div className="text-lg md:text-xl font-medium leading-relaxed space-y-8 flex flex-col items-center">
            <p className={`text-xl md:text-2xl font-bold max-w-xl text-[#55afe2]`}>
              To make creator knowledge accessible, personal, and worth sharing.
            </p>
            
            <div className={`italic font-semibold border-l-4 border-[#55afe2] pl-6 py-4 text-left mt-6 max-w-lg ${theme === 'light' ? 'text-gray-700 bg-gray-50' : 'text-gray-300 bg-gray-900'} rounded-r-xl`}>
              We believe great conversations shouldn't get buried in crowded inboxes.
            </div>
          </div>
        </div>
      </main>
