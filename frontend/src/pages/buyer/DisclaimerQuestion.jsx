          ...
          <>
            <div style={{ 
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '8px' }}>2. Be respectful. Abusive, hateful, or vulgar content is not allowed.</li>
                <li style={{ marginBottom: '8px' }}>3. Share only what's needed for a helpful answer.</li>
              </ul>
            </div>
